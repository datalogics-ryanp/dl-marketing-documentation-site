...
The \_\_ _**GetAvailableLanguages()**_ method of the **OCREngine** class can be used to list the available languages and the _**IsLanguageAvailble()**_ method can be used to check if a specific language file is available.
